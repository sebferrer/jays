...
export class Collision {
    ...
    static is_collision(collisioner_x1: number, collisioner_y1: number, collisioner_x2: number, collisioner_y2: number,
    ...
    static is_collision_entity_tile(entity: Entity, tile: Tile): boolean {
    ...
    static is_collision_nextpos_entity_tile(next_position: Position, entity: Entity, tile: Tile): boolean {
