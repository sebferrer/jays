...
import { IIConRoom } from "../iicon_room";

export class BossRoom extends RoomMap implements IIConRoom {
	...
	constructor(door_placement: Direction[]) {
		...
		this.icon = new WallSprite(new Point(0, 0), new Point(21, 21), "assets/img/minimap_icons.png");
	}
